...
export const ListOfCodeProjects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur scelerisque eget velit vitae placerat. Phasellus tempus fermentum enim eget sagittis. Quisque eget eros ut lorem efficitur scelerisque. Nulla quis turpis sollicitudin, finibus ligula ac, rhoncus augue. Praesent at metus consectetur, pharetra eros sit amet, aliquam purus. Vivamus vitae enim sapien. Donec non consequat velit.",
    asset: "../../../assets/code-projects/desktop_bullish_bay.gif",
    assetAlt: "Bullish Bay Desktop View GIF",
